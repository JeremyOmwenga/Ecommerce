<html>
    ...
    <br>
    <span id="usertype">
    <input type="radio" id="admin" name="user" value="1">
	...
	<p>Already have an account? <a href="login.php" class="nounderline" >Sign in</a></p>
  </div>
</form>
	</body>
</html>
